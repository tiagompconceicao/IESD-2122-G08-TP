 ...
 * 
 */
@WebServiceClient(name = "VectorService", targetNamespace = "http://servector.cesvector.isyiesd.tp1.isos/", wsdlLocation = "http://localhost:2058/Vector?wsdl")
    ...
    extends Service
{
    ...
    private final static QName VECTORSERVICE_QNAME = new QName("http://servector.cesvector.isyiesd.tp1.isos/", "VectorService");
    ...
    public IVector getVectorPort() {
        return super.getPort(new QName("http://servector.cesvector.isyiesd.tp1.isos/", "VectorPort"), IVector.class);
    }
    ...
    public IVector getVectorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servector.cesvector.isyiesd.tp1.isos/", "VectorPort"), IVector.class, features);
    }
